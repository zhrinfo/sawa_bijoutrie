                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/api/auth/**").permitAll()
                            ...
                            .requestMatchers("/api/reviews/product/**").permitAll()
                                ...
                                .requestMatchers("/api/delivery-addresses/**").permitAll()
                                .requestMatchers("/api/admin/products/best-selling").permitAll()
                                .requestMatchers("/api/reviews/random").permitAll()
                                .requestMatchers("/api/admin/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_SOUS_ADMIN")
