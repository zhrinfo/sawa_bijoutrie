...
import com.techshop.dto.JwtResponse;
import com.techshop.dto.LoginRequest;
import com.techshop.dto.SignupRequest;
...
import com.techshop.security.services.UserDetailsImpl;
        ...
        if (strRoles == null) {
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    ...
                    case "sousadmin":
                    case "sous_admin":
                        Role sousAdminRole = roleRepository.findByName(ERole.ROLE_SOUS_ADMIN)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(sousAdminRole);
                        break;
                    default:
                        Role userRole = roleRepository.findByName(ERole.ROLE_CLIENT)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
